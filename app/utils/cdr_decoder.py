...
#TODO: We need to make a proper CDR decoder for the messages, no matter the different frame_id values.
# However, for now, we just handle specific message types with specific frame_id individually
